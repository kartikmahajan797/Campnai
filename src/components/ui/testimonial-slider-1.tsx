...
interface TestimonialSliderProps {
  reviews: Review[];
  /** Optional label text shown vertically on the left */
  label?: string;
...
/**
 * A reusable, animated slider component.
...
export const TestimonialSlider = ({
  ...
  // Auto-cycle every 6 seconds, resets on any manual navigation
  useEffect(() => {
          ...
          <div className="relative overflow-hidden pt-4 md:pt-24 min-h-[200px]">
            <AnimatePresence initial={false} custom={direction} mode="wait">
              ...
              >
                ...
                <p className="mt-6 text-xl md:text-2xl font-medium leading-snug text-muted-foreground">
                  {activeReview.quote}
                </p>
              </motion.div>
            </AnimatePresence>
